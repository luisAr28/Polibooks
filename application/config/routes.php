...
$route['crear_fragmentacion/(:any)']='mantenimiento/muestraAtributos/$1';
$route['crear_fragmentacion/(:any)/(:any)/(:any)/(:any)/(:any)/(:any)']='mantenimiento/verificarMinimos/$select1/$2/$3/$4/$5/$6/$7';

*/
$route['Main_model/index'] = "Main_controller/index";
$route['404_override'] = '';
